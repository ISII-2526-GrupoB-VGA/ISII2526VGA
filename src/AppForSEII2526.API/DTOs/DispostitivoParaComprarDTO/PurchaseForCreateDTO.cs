...
namespace AppForSEII2526.API.DTOs.PurchaseDTOs
{
    public class PurchaseForCreateDTO
    {
        ...
        public PurchaseForCreateDTO() => PurchaseItems = new List<PurchaseItemDTO>();
        ...
        [MinLength(1)] public IList<PurchaseItemDTO> PurchaseItems { get; set; }
        ...
        public override bool Equals(object? obj) =>
            obj is PurchaseForCreateDTO dto &&
